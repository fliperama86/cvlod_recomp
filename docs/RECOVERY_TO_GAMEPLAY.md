...
- 2026-06-25 WIP warning: parent branch `wip/ni-mips-fallback-prototype` with RT64 commit `6ecc770` fixes the issue #19 cutscene/merchant route, but user validation reports the original Tower symptom again: black screen plus background music. Do not merge or release this RT64 NI code-target fallback until it is narrowed and Tower is revalidated.
