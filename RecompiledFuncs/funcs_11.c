                ...
                // Without it, the game draws empty framebuffers forever.
                {
                    ...
                    // We create a minimal object and call it directly.
                    {
                        ...
                        if (!ni_sys_done && (uint32_t)MEM_W(S32(0x801CAC1C), 0) == 0) {
                            ...
                            ctx->r4 = saved_r4;
                            // NOTE: NI init clears the pre-loaded file pointers.
                            // The initial pre-population in recomp.cpp stored physical
                            // addresses. We don't re-populate here — the initial values
                            // are lost, but the NI system itself manages file loading.
